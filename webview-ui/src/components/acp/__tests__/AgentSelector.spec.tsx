...
describe("AgentSelector", () => {
	...
	it("should render all configured agents", () => {
		render(<AgentSelector agents={agents} onSelectAgent={vi.fn()} />)
	...
	it("should highlight active agent", () => {
		render(<AgentSelector agents={agents} activeAgentId="copilot" onSelectAgent={vi.fn()} />)
