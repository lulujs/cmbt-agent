...
build_extension() {
  echo "🔨 Building the Test Agent extension..."
...
echo -n "🗄️ Syncing Test Agent evals database... "
...
read -p "💻 Do you want to build a new version of the Test Agent extension? [currently $current_version] (y/N): " build_extension
