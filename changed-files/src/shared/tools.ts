...
export const toolParamNames = [
	...
	"questions", // test-agent_change: multi-question carousel parameter
] as const
...
export interface AskFollowupQuestionToolUse extends ToolUse<"ask_followup_question"> {
	...
	params: Partial<Pick<Record<ToolParamName, string>, "question" | "follow_up" | "questions">> // test-agent_change: added questions
}
