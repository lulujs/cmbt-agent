...
Click the magic wand icon to make your prompt clearer and more complete. Test Agent will rewrite it to get better results.

# Add files or folders for context

Mention files or folders in your prompt. Test Agent will use them to better understand and respond to your request.
