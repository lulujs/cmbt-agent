...
The user has explicitly asked you to help them create a new Kilo rule file inside the .testcode/rules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Kilo rule.
...
Usage:
<new_rule>
<path>.testcode/rules/{file name}.md</path>
<content>Kilo rule file content here</content>
</new_rule>
Example:
<new_rule>
<path>.testcode/rules/project-preferences.md</path>
<content>
## Brief overview
