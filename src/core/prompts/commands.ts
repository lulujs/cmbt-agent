...
The user has explicitly asked you to help them create a new Kilo rule file inside the .testagent/rules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Kilo rule.
...
Usage:
<new_rule>
<path>.testagent/rules/{file name}.md</path>
<content>Kilo rule file content here</content>
</new_rule>
Example:
<new_rule>
<path>.testagent/rules/project-preferences.md</path>
<content>
## Brief overview
...
When you call the report_bug tool, the issue will be created at @https://github.com/issues
