...
/**
 * Converts .testagent/rules file to directory and places old .testagent/rules file inside directory, renaming it
 * Doesn't do anything if .testagent/rules dir already exists or doesn't exist
