...
/**
 * Converts .testcode/rules file to directory and places old .testcode/rules file inside directory, renaming it
 * Doesn't do anything if .testcode/rules dir already exists or doesn't exist
