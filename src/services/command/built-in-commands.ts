...
const BUILT_IN_COMMANDS: Record<string, BuiltInCommandDefinition> = {
	// kilocode_change start - Modified all .roo references to .kilocode for Test Agent fork
	init: {
		name: "init",
  ...
  <todo_list_creation>
    If the update_todo_list tool is available, create a todo list with these focused analysis steps:
     ...
     1. Check for existing AGENTS.md files
       ...
       - .testagent/rules-code/AGENTS.md (relative to project root)
       - .testagent/rules-debug/AGENTS.md (relative to project root)
       - .testagent/rules-ask/AGENTS.md (relative to project root)
       - .testagent/rules-architect/AGENTS.md (relative to project root)
    ...
    8. Compile/Update AGENTS.md files
       - If files exist: AGGRESSIVELY clean them up
        ...
        - Create mode-specific files in .testagent/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .testagent folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .testagent/rules-code/AGENTS.md (create .testagent in project root, not system root!)
    - .testagent/rules-debug/AGENTS.md (relative to project root)
    - .testagent/rules-ask/AGENTS.md (relative to project root)
    - .testagent/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .testagent directory must be created in the current project/workspace root directory,
    ...
    ├── .testagent/                   # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .testagent/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .testagent/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .testagent/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .testagent/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
