...
- Star the project
- Post on X or Linkedin about Test Agent `#kilocode
...
Custom modes are a powerful way to extend Test Agent's capabilities. To create and share a custom mode:
...
We love hearing how people use or extend Test Agent in their own projects. If you’ve written about your experience, we’re happy to review it!
...
- Open a Pull Request against the main Test Agent repository.
...
Your contributions, big or small help make Test Agent better for everyone!🫶
