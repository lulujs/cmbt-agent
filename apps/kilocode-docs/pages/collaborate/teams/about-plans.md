---
title: "About Plans"
description: "Overview of Test Agent plans and pricing"
---

# About Plans

Test Agent accelerates development with AI-driven code generation and task automation. You can use Test Agent as an open source extension in VS Code or JetBrains IDEs.
...
Test Agent's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Test Agent's paid plans are separate from model provider credits.
