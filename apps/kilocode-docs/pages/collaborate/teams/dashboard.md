---
title: "Dashboard"
description: "Manage your team from the Test Agent dashboard"
---

# Dashboard

The Kilo seats dashboard is the first screen that comes up when you visit [the Test Agent web app](https://app.kilo.ai). It provides complete visibility into your team's AI usage, costs, and management.
