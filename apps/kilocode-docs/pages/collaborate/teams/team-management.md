...
description: "Add and manage team members in Test Agent"
---
...
Members can use the Test Agent extension and see data on the team's usage in the [usage dashboard](/docs/plans/analytics).
