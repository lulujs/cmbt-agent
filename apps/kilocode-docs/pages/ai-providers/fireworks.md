---
title: Fireworks AI with Test Agent
---

# Using Fireworks AI With Test Agent
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Test Agent").
