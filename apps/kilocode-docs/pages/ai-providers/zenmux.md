...
3. **Configure in Test Agent:** Add your API key to Test Agent settings.
...
- Check the [Test Agent GitHub repository](https://github.com/kilocode/kilocode) for integration-specific issues
