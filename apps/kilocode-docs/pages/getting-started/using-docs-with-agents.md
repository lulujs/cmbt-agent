...
description: "Access the full Test Agent documentation in machine-readable formats for LLMs and AI agents"
---

# Using Kilo Docs with Agents

You can access the full text of the Test Agent documentation in machine-readable formats suitable for LLMs and AI agents. This is useful when you want an AI assistant to reference Test Agent's documentation while helping you with a task.
...
This file contains the full content of every page in the Test Agent docs, formatted for easy consumption by language models.
