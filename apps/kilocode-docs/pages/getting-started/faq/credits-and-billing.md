...
description: "Questions about credits, billing, and pricing in Test Agent"
tocDepth: 2
---

# Credits and Billing

This section contains questions about credits, billing, and pricing in Test Agent.

## Credits

### Why am I seeing requests for "Codestral 2508"?

Test Agent uses Codestral 2508 (a model by Mistral AI) as the dedicated engine for our Autocomplete feature. It is optimized for speed and low latency, making it perfect for real-time code suggestions.
