...
**Description:** When enabled, Kilo Code can overwrite or modify files that are normally protected by the [`.testcodeignore`](/docs/customize/custom-rules) file.
...
- Kilo Code still respects `.testcodeignore` rules
