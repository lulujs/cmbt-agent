...
The Model Context Protocol (MCP) is a standard for extending Test Agent's capabilities by connecting to external tools and services. MCP servers provide additional tools and resources that help Test Agent accomplish tasks beyond its built-in capabilities, such as accessing databases, custom APIs, and specialized functionality.

## MCP Documentation

This documentation is organized into several sections:

- [**Using MCP in Test Agent**](using-in-kilo-code) - Comprehensive guide to configuring, enabling, and managing MCP servers with Test Agent. Includes server settings, tool approval, and troubleshooting.
...
2. **Test thoroughly**: Ensure your server works correctly with Test Agent and handles edge cases gracefully
