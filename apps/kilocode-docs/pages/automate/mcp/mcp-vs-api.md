...
## Why Test Agent Uses MCP

Test Agent leverages MCP to provide:
...
MCP creates a universal connector between Test Agent and external services, with REST APIs often powering those services behind the scenes.
