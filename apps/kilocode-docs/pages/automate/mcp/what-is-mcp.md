...
Test Agent implements the Model Context Protocol to:
...
- [Using MCP in Test Agent](using-in-kilo-code) - Get started with MCP in Test Agent, including creating simple servers
