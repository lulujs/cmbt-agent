---
title: "Automate"
description: "Automate your development workflows with Test Agent"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Test Agent's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Test Agent to external tools and services:
...
- [**Using MCP in Test Agent**](/docs/automate/mcp/using-in-kilo-code) — Configuration guide
...
Connect Test Agent with your development tools:
...
Customize and extend Test Agent's capabilities:
