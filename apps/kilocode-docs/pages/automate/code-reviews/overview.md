...
- **Test Agent credits:** The AI model uses credits when analyzing your code.
...
- **Test Agent credits are still used** when the agent performs model reasoning during a review.
