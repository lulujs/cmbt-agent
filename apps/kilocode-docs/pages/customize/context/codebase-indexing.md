...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping Test Agent find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/docs/automate/tools/codebase-search) tool** to Test Agent for intelligent code discovery
...
- **Enhanced AI Understanding**: Test Agent can better comprehend and work with your codebase
...
3. If you don't see the icon, open Test Agent settings (<Codicon name="gear" />) and search for **Codebase Indexing**
...
- Files matching `.gitignore` and [`.testagentignore`](/docs/customize/context/kilocodeignore) patterns
...
Once indexed, Test Agent can use the [`codebase_search`](/docs/automate/tools/codebase-search) tool to find relevant code:
...
The tool provides Test Agent with:
