...
This directory contains the JetBrains plugin implementation for Test Agent, including both the IntelliJ plugin (Kotlin) and the Extension Host (Node.js/TypeScript).
